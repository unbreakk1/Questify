...
const DashboardPage: React.FC = () =>
    {
        ...
        const handleAttackAnimation = async () =>
        {
            if (isAttacking) return; // Prevent multiple simultaneous attacks
            setIsAttacking(true);
        ...
        const handleCompleteTask = async (taskId: string) =>
            {
                ...
                try
                {
                    ...
                    if (boss)
                    {
                        ...
                        {
                            setRewardAnimation({
                                gold: updatedBoss.rewards.gold,
                                xp: updatedBoss.rewards.xp,
                                levelUp: updatedBoss.rewards.hasCausedLevelUp
                            });
        ...
        const handleCompleteHabit = async (habitId: string) =>
            {
                ...
                try
                {
                    ...
                    if (boss)
                    {
                        ...
                        {
                            setRewardAnimation({
                                gold: updatedBossResponse.rewards.gold,
                                xp: updatedBossResponse.rewards.xp,
                                levelUp: updatedBossResponse.rewards.hasCausedLevelUp
                            });
        ...
        return (
            <Box sx={{display: 'flex', flexDirection: 'column', minHeight: '100vh'}}>
                ...
                {rewardAnimation && (rewardAnimation.gold || rewardAnimation.xp || rewardAnimation.levelUp) && (
                    <RewardAnimation
                        gold={rewardAnimation.gold}
                        xp={rewardAnimation.xp}
                        levelUp={rewardAnimation.levelUp}
